    ...
    return (
      <Form onSubmit={handleSubmit}>
        <FormGroup
          ...
          validated={errors.file ? 'error' : 'default'}
        >
          <Dropzone onDrop={onDrop} noClick={true} noKeyboard={true} multiple={false}>
                  ...
                  <div {...getRootProps({ className: 'dropzone' })}>
                    ...
                    <InputGroup>
                      <TextInput
                        ...
                        validated={errors.file && touched.file ? 'error' : 'default'}
                      />
                      <Button
        ...
        <FormGroup
          ...
          validated={errors.reportName && touched.reportName ? 'error' : 'default'}
        >
          <TextInput
            isRequired={true}
            type="text"
        ...
        <FormGroup
          ...
          validated={
            errors.yearOverYearGrowthRatePercentage && touched.yearOverYearGrowthRatePercentage
              ? 'error'
              : 'default'
          }
        >
            ...
            <GridItem>
              <InputGroup>
                <TextInput
                  ...
                  validated={
                    errors.yearOverYearGrowthRatePercentage &&
                    touched.yearOverYearGrowthRatePercentage
                      ? 'error'
                      : 'default'
                  }
                />
        ...
        <Stack hasGutter={true} className="pf-sm-gutter">
          <StackItem isFilled={false}>
            <label className="pf-c-form__label">
              <span className="pf-c-form__label-text">
                Percentage of hypervisors migrated each year
              </span>
            </label>
          </StackItem>
          <StackItem isFilled={false} className="upload-form-subform-margin-left">
            <FormGroup
              ...
              helperTextInvalid={
                ...
                errors.percentageOfHypervisorsMigratedSum
              }
              validated={
                (errors.percentageOfHypervisorsMigratedOnYear1 &&
                  touched.percentageOfHypervisorsMigratedOnYear1) ||
                errors.percentageOfHypervisorsMigratedSum
                  ? 'error'
                  : 'default'
              }
          ...
          <StackItem isFilled={false} className="upload-form-subform-margin-left">
            <FormGroup
              ...
              validated={
                (errors.percentageOfHypervisorsMigratedOnYear2 &&
                  touched.percentageOfHypervisorsMigratedOnYear2) ||
                errors.percentageOfHypervisorsMigratedSum
                  ? 'error'
                  : 'default'
              }
          ...
          <StackItem isFilled={false} className="upload-form-subform-margin-left">
            <FormGroup
              ...
              validated={
                (errors.percentageOfHypervisorsMigratedOnYear3 &&
                  touched.percentageOfHypervisorsMigratedOnYear3) ||
                errors.percentageOfHypervisorsMigratedSum
                  ? 'error'
                  : 'default'
              }
        ...
        <ActionGroup>
          ...
          <Button variant="secondary" type="button" onClick={this.props.handleCancel}>
            Cancel
          </Button>
        </ActionGroup>
      </Form>
