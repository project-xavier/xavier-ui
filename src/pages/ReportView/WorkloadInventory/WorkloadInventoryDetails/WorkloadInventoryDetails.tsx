...
export class WorkloadInventoryDetails extends React.Component<WorkloadInventoryDetailsProps> {
    ...
    return (
      <div className="pf-c-content">
        <dl>
          ...
          <dd>
            {reportWorkloadInventory.recommendedTargetsIMS.map((e, index) => {
              return (
                <Tooltip
                  key={index}
                  position="top"
                  content={<div>VM suitable to be migrated to {e}</div>}
                >
                  <React.Fragment>
