...
export function getAllReports(
  ...
  perPage: number,
  filterText: string
): AxiosPromise<SearchResult<Report>> {
...
export function getReportInitialSavingestimation(
  id: number
): AxiosPromise<ReportInitialSavingEstimation> {
...
export function getReportWorkloadInventoryAvailableFilters(
  ...
  return ApiClient.get<WorkloadInventoryReportFiltersModel>(
    `/report/${id}/workload-inventory/available-filters`
  );
}
