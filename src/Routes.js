...
const Reports = asyncComponent(() => import(/* webpackChunkName: "Reports" */ './pages/Reports'));
  ...
  return (
    <Switch>
      ...
      <InsightsRoute
        ...
        rootClass="reports-upload"
        path={paths.reportsUpload}
      />
      ...
      <Route
        render={() =>
          some(paths, (p) => p === path) ? null : <Redirect to={paths.gettingStarted} />
        }
      />
    </Switch>
  );
