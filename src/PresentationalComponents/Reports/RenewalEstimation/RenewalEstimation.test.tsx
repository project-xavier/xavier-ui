...
describe('RenewalEstimation', () => {
  it('expect to render', () => {
    ...
    const wrapper = shallow(<RenewalEstimation data={data} />);
  ...
  it('expect to render using null and undefined data', () => {
    ...
    const wrapper1 = shallow(<RenewalEstimation data={sourceCostModel} />);

    expect(wrapper1).toMatchSnapshot();

    Object.keys(sourceCostModel).forEach((key) => (sourceCostModel[key] = undefined));

    const wrapper2 = shallow(<RenewalEstimation data={sourceCostModel} />);
