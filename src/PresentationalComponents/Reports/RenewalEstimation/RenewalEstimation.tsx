...
import { Table, TableBody, TableVariant, TableHeader } from '@patternfly/react-table';
...
class RenewalEstimation extends Component<Props> {
  ...
  public render() {
    const {
      data: { sourceRenewHighValue, sourceRenewLikelyValue, sourceRenewLowValue },
    } = this.props;
    ...
    const rows = [
      [
        '-- As high as...',
        isNullOrUndefined(sourceRenewHighValue)
          ? 'Unknown'
          : formatValue(sourceRenewHighValue, 'usd', { fractionDigits: 0 }),
      ],
      [
        '-- Most likely...',
        isNullOrUndefined(sourceRenewLikelyValue)
          ? 'Unknown'
          : formatValue(sourceRenewLikelyValue, 'usd', { fractionDigits: 0 }),
      ],
      [
        '-- As low as...',
        isNullOrUndefined(sourceRenewLowValue)
          ? 'Unknown'
