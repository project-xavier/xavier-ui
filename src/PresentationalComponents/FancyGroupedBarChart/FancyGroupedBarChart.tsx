...
class FancyGroupedBarChart extends Component<Props> {
  ...
  public render() {
    ...
    const {
      style: dependenAxisStyles,
      ...restDependentChartAxisProps
    } = dependentChartAxisProps || { style: {} };
    const {
      style: independenAxisStyles,
      ...restIndependentChartAxisProps
    } = independentChartAxisProps || { style: {} };
        ...
        <div className="fancy-groupped-bar-chart-container">
          ...
          >
            ...
            <ChartAxis
              ...
              {...restDependentChartAxisProps}
            />
            <ChartGroup colorScale={colors} {...chartGroupProps}>
